...
{
    [Autenticado]
    public class HojaVidaDocenteHonoresPremiosController : Controller
    {
        private HojaVida hojavida = new HojaVida();
        private HojaVidaDocenteHonoresPremios crp = new HojaVidaDocenteHonoresPremios();
        ...
        public ActionResult AgregarEditar(int id = 0)
        {
            ...
            return View(
                id == 0 ? new HojaVidaDocenteHonoresPremios()//generar un nuevo semestre
        ...
        public ActionResult Guardar(Usuario model)
        {
            ...
            {
                model.Guardar();
                return Redirect("~/HojaVidaDocenteHonoresPremios");//se referencia al index automaticamente
            }
            else
            {
                return View("~/views/HojaVidaDocenteHonoresPremios/AgregarEditar.cshtml", model);
            }
        }
        public ActionResult Eliminar(int id)
        {
            crp.idHojaVidaDocenteHonoresPremios = id;
            crp.Eliminar();
