    ...
    public class DocumentoController : Controller
    {
        ...
        public JsonResult SubirDocumento(Documento model, HttpPostedFileBase archivo, string[] aceptar = null)
        {
            ...
            else
            {
                ...
                if (flag)
                {
                    rm.href = Url.Content("~/Admin/Documento/Verificar");
                    rm.SetResponse(true);
                    return Json(rm);
                }
                else
                {
                    ...
                    if (rm.response)
                    {
                        rm.href = Url.Content("~/Admin/Documento/Detalle/" + model.documento_id);
                        return Json(rm);
                    }
                    else
                    {
        ...
        public ActionResult EliminarDocumento(int id)
        {
            ...
            return Redirect("~/Admin/Documento/MiDocumento/" + Session["enlace"].ToString());
        }
