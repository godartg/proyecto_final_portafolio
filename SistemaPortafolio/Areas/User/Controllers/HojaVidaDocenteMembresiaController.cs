...
namespace SistemaPortafolio.Areas.Admin.Controllers
{
    ...
    public class HojaVidaDocenteMembresiaController : Controller
    {
        ...
        private HojaVidaDocenteMembresia crp = new HojaVidaDocenteMembresia();
        ...
        public ActionResult AgregarEditar(int id = 0)
        {
            ...
            return View(
                id == 0 ? new HojaVidaDocenteMembresia()//generar un nuevo semestre
        ...
        public ActionResult Guardar(Usuario model)
        {
            ...
            {
                model.Guardar();
                return Redirect("~/HojaVidaDocenteMembresia");//se referencia al index automaticamente
            }
            else
            {
                return View("~/views/HojaVidaDocenteMembresia/AgregarEditar.cshtml", model);
            }
        }
        public ActionResult Eliminar(int id)
        {
            crp.idHojaVidaDocenteMembresia = id;
            crp.Eliminar();
